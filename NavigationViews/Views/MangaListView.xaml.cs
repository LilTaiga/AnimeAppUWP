...
namespace AnimeAppUWP.NavigationViews.Views
{
    ...
    public sealed partial class MangaListView : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            FillDisplayEntries(profileData.MangaReadingList.lists.Find(_list => _list?.name == "Reading"));
            FillDisplayEntries(profileData.MangaRereadingList.lists.Find(_list => _list?.name == "Rereading"));
            DisplayEntries();
        }
